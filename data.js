...
window.MACRO_DATA = {
  ...
  cards: [
    ...
    {
      icon: "🌏", title: "Asia extras", subtitle: "China · Japan · Korea", tag: "Nhật nghỉ", tagClass: "",
      level: "LPR giữ",
      cols: ["Chỉ số", "% ngày", "% tuần"],
      rows: [
  ...
  comment: {
    ...
    paragraphs: [
      ...
      "<strong>5) Trung Quốc.</strong> PBoC giữ LPR 1Y 3.00% / 5Y 3.50% tháng thứ 16. Trọng tâm gần: Trump–Tập 24/09 và gia hạn truce thuế, không phải nới thêm tức thì.",
      "<strong>6) Vĩ mô toàn cầu khác.</strong> Không CPI/PCE mới. Equities Mỹ 21/09: S&P ~7,765 (+1.49%), Nasdaq +2.26%. WTI ~$92 (−3.59%), Brent ~$100 (−3.28%), Gold ~$4,405, BTC ~$86.5k (+6.5%). Catalyst: Trump–Xi 24/09, Iran airlines 23/09, Aug PCE 30/09, Sep CPI 14/10.",
      ...
      "<strong>0) Kịch bản nghiên cứu 24–72h (không phải lời khuyên đầu tư).</strong> <em>Base:</em> UNGA giữ premium dầu hạ (Brent ~$95–105), Trump–Tập gia hạn truce kỹ thuật, Fed restrictive — USD/yields được đỡ. <em>Upside:</em> Trump–Pezeshkian tiến triển + truce Mỹ–Trung rõ → dầu lùi, risk-on. <em>Downside:</em> bước quân sự / đòn Hormuz / truce vỡ → dầu spike, USD/risk-off.",
      "<strong>5) Chiến lược Trading.</strong> (i) Bias: restriction + geo đang bị ngoại giao kéo xuống tạm — chưa all-clear. (ii) Rates/FX: DXY >100 và 2s10s đảo; đừng đọc yields dịu = pivot Fed. (iii) Energy: WTI <$95 là phản ứng ngoại giao — size nhỏ trước Iran/UNGA. (iv) VN: ưu tiên thanh khoản NHNN (OMO + swap FX) và vùng 1,790–1,800. (v) Catalyst: Trump–Xi 24/09, Iran cutoff 23/09, PCE 30/09."
    ]
  },
  bottomLine: [

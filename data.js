...
window.MACRO_DATA = {
  ...
  trading: {
    ...
    body: "(i) Bias chung vẫn là Fed restrictive kết hợp rủi ro địa chính trị, dù ngoại giao đang kéo premium xuống tạm thời — chưa thể coi là all-clear. (ii) Với rates và FX, DXY vẫn trên 100 và đường cong 2s10s còn đảo; không nên đọc việc lợi suất dịu nhẹ như tín hiệu Fed sắp pivot. (iii) Ở năng lượng, WTI dưới 95 USD phản ánh kỳ vọng ngoại giao hơn là rủi ro cung đã hết — nên giữ quy mô nhỏ trước các mốc Iran và UNGA. (iv) Với Việt Nam, ưu tiên theo dõi thanh khoản NHNN qua OMO và hoán đổi FX, cùng vùng hỗ trợ VN-Index 1.790–1.800. (v) Các catalyst gần: hạn chế hàng không Iran 23/09, Trump–Tập 24/09 và Aug PCE 30/09."
  },
  sources: "CafeF — NHNN mở kênh bơm VND >48.000 tỷ; Thời báo Tài chính VN — tiền tệ tuần 14–18/9; Newsquawk Asia-Pac 22/09; CNBC/Bloomberg/Reuters wires; Fed FOMC 16/09; Investing delayed quotes.",
  bottomLine: [
